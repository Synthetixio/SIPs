...
What are Delegates and what are their current powers? Delegates are trusted wallet addresses that you can set to claim the weekly rewards on your behalf. This function is already live on SNX mainnet however adoption will likely be limited if the delegates are not able to help their owner to fix their c-ratio if they are in penalty before claiming the rewards. By upgrading the current powers of Delegates, we will be able to explore the powers of this feature and hopefully help minters life to be easier and less #tech-support issues with their ledger wallet. This will also encourage 3rd party integrations to use an automated delegate to help claim the weekly rewards
