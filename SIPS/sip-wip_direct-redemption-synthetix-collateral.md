...
1. Allows holders of Synths to burn synth debt and redeem the underlying synthetix collateral.
...
1. Provide a liquidation contract for someone to mark a SNX staker as being liquidated but give time for them to fix c-ratio / burn debt (This was raised as an idea by guardians).
2. Prevents black swan events where malicious actor quickly dumps a sizeable amount of SNX on CEX’s to push the price down suddenly and target liquidation, as there is a time delay for liquidation.
