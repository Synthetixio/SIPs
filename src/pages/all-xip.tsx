...
import { AllXipsQuery } from '../../types/gql'
...
const Template: React.FC<Props> = ({ data: { allMarkdownRemark } }) => {
  ...
  )(group) as AllXipsQuery['allMarkdownRemark']['group']

  return (
    <Main>
      <Helmet title="All XIPs" />
      <header className="post-header">
        <h1 className="post-title">All XIPs</h1>
      </header>
      <div className="post-content">
        {columns.map((g) => {
          const rows = sortBy('frontmatter.xip')(g.nodes)
          return (
