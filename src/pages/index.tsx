...
const IndexPage = () => (
  <Main>
    ...
    <p>
      Soft Enahancement Proposals (SEPs) describe standards for the
      Soft platform, including core protocol specifications, client APIs,
    ...
    <ol>
      <li>
        Review <a href="/seps/sep-1">SEP-1</a>.
      </li>
      <li>
        Fork the repository by visiting the SEPs{' '}
        <a href="https://github.com/softdao/SEPs">repo</a> and pressing
    ...
    <p>
      ...
      subdirectory of the `assets` folder for that SEP as follow: <code>seps/assets/sep-X</code> (for sep <b>X</b>). When linking to an
    ...
    <p>
      ...
      <code>Draft</code> phase, you should reach out to a Soft Council member
      on discord by searching members with the "Soft Council" role or finding
      them within the #governance channel. The Soft Council will schedule in
      a call with the SEP author to go through the SEP in more detail.
    </p>
    ...
    <p>
      ...
      satisfied, a SEP is moved to <code>SC Review Pending</code>. Once the
      Soft Council has formally reviewed the SEP during the SEP presentation
      they can either move it to a vote or send it back to{' '}
      <code>Feasability</code>. A vote is conducted within the{' '}
      <code>INSERT ENS NAME</code> snapshot space connected on the
      <a href="https://"> staking </a> dApp. If a vote by
      the Soft Council reaches a super majority, the SEP is moved to{' '}
    ...
    <ul>
      <li>
        <strong>Draft</strong> - The initial state of a new SEP before the
        Soft Council and core contributors have assessed it.
      </li>
      <li>
