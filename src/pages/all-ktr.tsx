...
import { AllKtrsQuery } from '../../types/gql'
...
const Template: React.FC<Props> = ({ data: { allMarkdownRemark } }) => {
  ...
  )(group) as AllKtrsQuery['allMarkdownRemark']['group']

  return (
    <Main>
      <Helmet title="All KIPs" />
      <header className="post-header">
        <h1 className="post-title">All KTRs</h1>
      </header>
      <div className="post-content">
        {columns.map((g) => {
          const rows = sortBy('frontmatter.ktr')(g.nodes)
          return (
