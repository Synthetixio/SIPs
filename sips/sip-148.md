...
2. The debt shares of the liquidated staker is updated (during the debt burn action) within the liquidation transaction before the liquidated SNX is rewarded to the liquidated SNX contract.
3. Liquidated staker will recieve less of the liquidated SNX as their debt % is lower after the burning of the debt.
4. The effective debt % of other stakers would increase after the liquidated staker's debt is burned.
5. The SNX claimed will be escrowed for 12 months on the escrow contract.
