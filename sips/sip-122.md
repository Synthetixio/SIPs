...
Collapsible shorts represent an improvement to the current shorting program, by allowing liquidation by keepers, or even the borrowers themselves, to bring an under-collateralized position back to health, by utilizing the sUSD collateral locked to repay the excess debt.
