...
- The leverage effect increases as the price gets closer to the upper and lower limits because the cost of buying a unit decreases as it approaches the limits.
...
- Incentive programs require manual enrolment by the user.
