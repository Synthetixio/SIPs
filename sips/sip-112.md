...
Upon initial release sFB, sAMZN, sAAPL, sNTLX, and sGOOGL will take into account periods of Market Closures:
...
- Secondary markets could be created with an AMM such as Uniswap or Balancer, which allow trading to continue on those platforms
  - There could be a SNX liquidity incentives for a sFB, sAMZN, sAAPL, sNTLX, and sGOOGL. Each could be paired with a sUSD in a pool that ensures deep liquidity persists during periods of market closure 
