...
This proposal will enable proposed SIPs to be voted on by the Spartan Council. This SIP will transition the voting process from the #governance-polls channel to https://gov.synthetix.io. Voting power will not be removed from the Synthetix community but simply delegated to those who hold a Spartan Council NFT through the official Spartan Council Governance process, identical to how SCCP voting was delegated to the Spartan Council already.
