...
1. Adding the `electionHash` when a proposal is created so we can access the election epoch in which a proposal was created within
...
3. Modifiying the view function
