...
As this SIP only proposed supporting SNX staking, there will be no trading rewards to claim on L2. Thus only SNX rewards are relevant, and those will only
