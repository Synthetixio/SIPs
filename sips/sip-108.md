...
For a period of 4 weeks, the sDAO will pay SNX rewards to users who short sBTC and sETH. The rate will be 16k SNX per week for each token.

## Abstract
<!--A short (~200 word) description of the proposed change, the abstract should clearly describe the proposed change. This is what *will* be done if the SIP is implemented, not *why* it should be done or *how* it will be done. If the SIP proposes deploying a new contract, write, "we propose to deploy a new contract that will do x".-->

Users who open sBTC or sETH shorts will be automatically enrolled into an SNX rewards program, similar to the iBTC and iETH programs. If their position is modified (increased, decreased, liquidated or closed), their rewards balance will be updated for them by the contract.
