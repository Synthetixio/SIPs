...
Given the timeline to implement this change if this SIP is passed it is proposed to continue with one more council epoch according to SIP-93 to ensure that the Spartan Council does not sit in limbo, where voters cannot adjust their votes nor dissent against the existing council members.
