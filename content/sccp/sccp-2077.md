...
2) Adding the gnosis safe `0x4324e64d4Fa6c63900987dafBA5343155561Da96`  as an endorsed account. 
The endorsed account is a 2 of n multisig, with 1 of the accounts being a deployer that can automatically stage the necessary transaction to lower the max market value to zero, the rest of the owners on the multisig would be accounts controlled by individuals designated on the interim risk council by the spartan council.
