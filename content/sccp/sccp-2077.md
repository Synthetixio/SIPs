...
2) Adding the gnosis safe [`0x4324e64d4Fa6c63900987dafBA5343155561Da96`](https://optimistic.etherscan.io/address/0x4324e64d4Fa6c63900987dafBA5343155561Da96)  as an endorsed account. The endorsed account is a 2 of n multisig, with 1 of the accounts being a deployer that can stage the necessary risk covering transaction. The rest of the owners on the multisig would be hardware wallet accounts, controlled by different individuals serving on the interim risk council.
