...
1) Cover the below markets to the MMV control module,  outlined in [SIP-2048](https://sips.synthetix.io/sips/sip-2048/):
...
2) Adding the account `0x8cE541adA76121f0D3B667739a8ea76783205bFA`  as an endorsed account.
...
The motivation is to enable to MMV risk module, that is able to decrease the `maxMarketValue` to zero, when certain market conditions arise that exposed Liquidity Providers to a market skew that can't be hedged with external exchange markets. 
