...
- `exchangeDynamicFeeThreshold` is the minimum change in price above which dynamic fees are levied. A higher threshold leads to lower dynamic fees.
- `exchangeDynamicFeeRounds` is the length of the look-back window. The shorter the lookback window, the less persistent is historical price volatiltiy on dynamic fees of future rounds.
...
The primary motivation is to improve the trading experience without increasing the risk of oracle latency arbitrage. 
...
|    **New      Config.**   	| **eth**  	|   44 bp  	|  22 bp  	|   216 sec   	|   203 sec   	|    61 sec    	|
|                           	| **btc**  	|   42 bp  	|  19 bp  	|    76 sec   	|    59 sec   	|     0 sec    	|
|                           	| **link** 	|   46 bp  	|  19 bp  	|   181 sec   	|   118 sec   	|     0 sec    	|
|                           	| **sol**  	|   43 bp  	|  15 bp  	|   117 sec   	|   116 sec   	|     0 sec    	|  
