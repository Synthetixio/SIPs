...
| ----------- | ----------- | ----------- |
| Hacker Steals Email | -> Reset Password <br> -> Login <br> -> Get MFA Signature <br> -> Add New Browser Key **(Inactive)** <br> -> Wait 7 Days **(Activate Browser Key)** <br> -> **DRAIN** | We can’t protect them beyond this, because ABK is encrypted and we can only gate that with password or OTP. <br> So, email OTP will always be the point of failure |
