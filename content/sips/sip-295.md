---
sip: 295
title: Adding BTC, SOL, AVAX, MATIC, DOGE, APE, BNB to Synthetix Perps V2
network:  Optimism
status: Draft
type: Governance
author: Matt
...
Create Synthetix Perps V2 markets for BTC, SOL, AVAX, MATIC, DOGE, APE, and BNB

## Abstract

This is a proposal to offer BTC-PERP, SOL-PERP, AVAX-PERP, MATIC-PERP, DOGE-PERP, APE-PERP, BNB-PERP futures which track the price of their respective cryptocurrency.
...
BTC, SOL, AVAX, MATIC, DOGE, APE, and BNB are well-established cryptocurrencies currently unavailable for trading on Perps V2. The inclusion of these markets in Synthetix Perps V2 will provide additional trading opportunities for traders.
