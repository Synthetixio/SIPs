...
The expected cost of this plan should be around 1% of the unwound amount, given the associated transaction cost of swapping sUSD to sETH (25 bp) and swapping ETH to LUSD (30 bp).
