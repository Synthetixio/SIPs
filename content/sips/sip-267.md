...
#### setIntegration
`setIntegrationInteraction` allows the protocol to specify the exchange functionalities that go through the `DirectIntegration` contract. It takes in the following structure:
