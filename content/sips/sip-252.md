...
- Upon liquidation / self-liquidation, the SNX relinquished by the delinquent account can be claimable by SNX stakers with the same duration as liquidated transferrable SNX (currently a year).  
