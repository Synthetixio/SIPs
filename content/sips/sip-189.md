...
In the long run, these stable coin wrapprs might not be needed as after the implementation of [SIP-165](https://sips.synthetix.io/sips/sip-165/), L1 sUSD and  L2 sUSD can be interchanged and therefore sUSD supply on optimisim will grow organically.
