...
\*_Proposals in this early revision are to still be carried out on snapshot until the introduction of the Governor Module, this is further explained in the Council Dismissal section _
...
It is important to note that _drifting \_may occur due to the evaluation and resolution stages being \_kept_. To help maintain human-friendly dates, the epoch scheduling can be adjusted in two ways:
