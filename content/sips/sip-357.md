...
The chainlink node would have a staleness check based on the [heartbeat](https://docs.chain.link/data-feeds/price-feeds/addresses?network=ethereum&page=1&search=snx) of the respective network. The configuration on optimism would be 3,600 seconds (1 hour) and that of optimism would be 129,600 seconds (36 hours).
