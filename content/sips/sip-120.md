...
Initially, this SIP proposes to use an `IDexPriceAggregator` that sources prices solely from Uniswap V3, returning the worst price between the "spot" and TWAP. This initial oracle has been deployed to [`0xf120F029Ac143633d1942e48aE2Dfa2036C5786c` (`DexPriceAggregatorUniswapV3`)](https://etherscan.io/address/0xf120f029ac143633d1942e48ae2dfa2036c5786c#readContract).
...
- `SystemSettings.atomicMaxVolumePerBlock`: 500,000 sUSD
...
Closer towards deployment, a sandbox version of the updated exchange mechanism in this SIP was deployed to [another `SynthetixAMM` contract](https://etherscan.io/address/0xacd76794a430e337958f332562ecc6575a164fee#code). This version piggybacked on the existing L1 Synthetix deployment to be as close to a real deployment as possible.
