...
Note that the spartan council can disable this functionality by simply instructing pdao to remove the module ability to update the `minKeeperFee` and this can be triggered out of the box with the existing gnosis safe. 
