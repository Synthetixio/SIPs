...
- The calculation steps of the minKeeperFee is as follows:
 1) `costOfExecutionGross := (gasPriceL2 * gasUnitsL2 + l1BaseFee * gasUnitsL1 * feeScalarL1) * ETH/USD * ETHPerGwei`
...
- `gasPriceL2`, `gasPriceL1` and `feeScalarL1` can be all queried with the [gasPriceOracle](https://optimistic.etherscan.io/address/0x420000000000000000000000000000000000000F#readContract)
...
- `costOfExecutionGrossGwei` = (0.001 * 1.2e6 + 29e3 * 92 * 1) = 2,669,200 GWEI
- `costOfExecutionGrossETH` = (0.001 * 1.2e6 + 29e3 * 92 * 1) = 0.002669 ETH
- `costOfExecutionGrossUSD` = 0.002669 ETH * 1,869 USD / ETH = 5 sUSD
