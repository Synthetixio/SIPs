...
*V3 FeePool and Staking Rewards*

The weekly rewards and fees distributed by the fee pool can be upgraded to use the balance of their debt shares and the total supply to fairly distribute the fees and SNX rewards.

Having debt shares (following ERC20 pattern) allows the staking rewards style contracts to be used to distribute SNX rewards and exchange fees to stakers continuously. This would be a separate SIP to describe how rewards and fees can be distributed using the staking rewards contract, removing the concept of fee periods.
