...
Update the atomic exchange functionality, laid out in [SIP-120](https://sips.synthetix.io/sips/sip-120/), implementing the following:
...
The restriction on the source currency or destination currency being in sUSD was incorporated in SIP-120 as a safety precaution. However, this can be relaxed as to accomodate for cross-foreign-currency trades.
