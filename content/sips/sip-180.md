...
This SIP proposes the creation of the Aelin Protocol, this protocol is an open and permissionless factory contract that enables anyone to instantiate a pool of capital that can be used to source deals within the crypto space.
