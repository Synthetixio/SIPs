...
- At blockNumber 10, Swap 1m sUSD to sETH with atomic price at 1,600$ per ETH
  ...
  $$
  G(1m,0) =  2 \frac {\frac{2}{3} - 1.314892 * 10^{-3} * (|10m| ^ {3/2} - |0|^ {3/2} ) + \frac{1}{2} + 1.434469 * 10^{-5} * (|10m|^2 - |0|^2)}{|10m| - |0|} => 12.59 bp
  $$
...
- At blockNumber 10, Swap 30 sETH with atomic price at 1,600$ per ETH
  ...
  3) Is Sign of x (52k$) is different from sign of y (0) >> False
