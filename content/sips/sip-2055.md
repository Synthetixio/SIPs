...
The sip proposes to create a new dynamic gas fee module, implemented previously in [SIP-2013](https://sips.synthetix.io/sips/sip-2013/) in order to take into account the changes with the [optimism ecotone upgrade](https://docs.optimism.io/stack/transactions/fees#ecotone) expected to take place at slot [296568](https://beaconcha.in/slot/8626176).
