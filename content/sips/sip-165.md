...
[SIP 185](https://sips.synthetix.io/sips/sip-185) introduces a new debt shares method of tracking the debt percentage ownership of stakers on L1 and L2.
In order to combine the debt shares supply between the chains, the Chainlink oracle must update / aggregate the total supply of debt shares across all chains into a single number and reported.
