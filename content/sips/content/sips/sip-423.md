...
status: "[Voting](https://snapshot.org/#/s:snxgov.eth/proposal/0x3cbe7236d2b112ebc5032a3dd534c93091f0dd9bd04c2e9151ab2e25ecfd66d3)"
proposal: 
type: Governance
author: Kain Warwick and Benjamin Celermajer
created: 2026-06-12
---
...
2. **sUSD retirement** - Freeze sUSD and deprecate the contract (reducing supply to zero). Before the 1 year lock completes, a receipt contract will be deployed and seeded from the snapshot, where sUSD at $1 value will be redeemed for 4 SNX on Ethereum Mainnet (1 year lock + 1 year vest from the time of freeze).
...
Subject to the protocol generating material revenue (e.g. >$10M within the 2-year lock-up period — configurable via SCCP), a mechanism will be created to distribute 25% of this revenue (also configurable via SCCP) back to legacy sUSD holders who wish to receive USDT in lieu of their SNX claim.
...
- Allows eligible holders to claim new SNX at a conversion ratio derived from valuing sUSD at $1 and SNX at the $0.25.
...
| -------- | -------- | 
| Conversion Ratio | 4 SNX per 1 sUSD entitlement |
...
|       sUSD:SNX Conversion ratio      |            1:4               |                      New SNX per legacy sUSD entitlement                      |
...
|    Synthetix revenue hurdle            |              $10m            |                  Amount of revnue the protocol needs to generate before creating a sUSD for USDT claim mechanism             |
| Share of revnue for sUSD distribution  |              25%             |   The percentage of revenue used to redeem sUSD claims at 1 USDT once the Synthetix revenue hurdle is achieved                 |
