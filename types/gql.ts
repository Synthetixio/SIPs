...
export type FrontmatterFragment = Pick<
...
export type SccpPageQuery = {
  markdownRemark?: Maybe<
    Pick<MarkdownRemark, 'html'> & { frontmatter?: Maybe<FrontmatterFragment> }
  >
}
